    ...
    public void process(IPluginXmlContext pluginXmlContext, Element element, TypeElement typeElement, ProcessingEnvironment processingEnv) {
        ...
        if (element.getKind() == ElementKind.CLASS) {
            ...
            if (tableData != null) {
                ...
                pluginXmlContext.addImplementation(xmlTag, DefaultClassInfo.of(TableDataDefineProvider.class, qualifiedClassName));
            }
            ...
            if (serverTableData != null) {
                ...
                xmlTag = this.getXmlTag(element, typeElement, TableDataDefineProvider.class);
                pluginXmlContext.addImplementation(xmlTag, DefaultClassInfo.of(ServerTableDataDefineProvider.class, qualifiedClassName));
            }
        }
    }
